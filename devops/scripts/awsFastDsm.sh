...
until yum -y install docker-engine
do
    sleep 0.5
done
...
curl -O "https://s3.amazonaws.com/424d57/bmwsecjam2018/SecJamPolicies.xml"
...
echo "Override.SecurityProfilesFilename=/opt/fastdsm/SecJamPolicies.xml" >> dsm.props
...
curl -O https://s3.amazonaws.com/424d57/bmwsecjam2018/SecJamSetAIA.sh
chmod 755 SecJamSetAIA.sh
...
./SecJamSetAIA.sh ${dsmuser} ${dsmpw} localhost 443
